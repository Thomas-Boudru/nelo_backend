...
router.post('/rankUsersByEvent', limiter, async (req, res) => {
    ...
    try {
      ...
      const updateData = {
        'statistic.statistics.topUsersByTokens': populatedTopUsersByTokens,
        'statistic.statistics.topTransactionsByTokens': populatedTopTransactionsByTokens,
        'statistic.statistics.generatedAtUTC': currentTimeUTC
      };
